...
// const MyPostWidget = async ({ picturePath }) => {
...
//                 <InputBase placeholder="What's on your mind..." onChange={(event) => setPost(event.target.value)} value={post} sx={{ width: "100%", backgroundColor: palette.neutral.light, borderRadius: "2rem", padding: "1rem 2rem" }} />
//             </FlexBetween>
//             {isImage && (
